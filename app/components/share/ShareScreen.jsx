    ...
    <section className="flex-1 flex items-start justify-center p-6">
      <div className="bg-surface/92 border border-border/12 rounded-lg shadow-strong backdrop-blur-[18px] p-6 w-full max-w-lg grid gap-5">
        ...
        <div className="grid gap-3">
          <div className="p-4 bg-white/[0.92] border border-border/[0.12] rounded-md shadow-soft flex flex-col gap-1">
        ...
        <button className="inline-flex items-center justify-center gap-3 min-h-[54px] px-7 py-4 rounded-pill text-base font-extrabold cursor-pointer bg-accent text-white shadow-[0_16px_32px_rgba(216,180,160,0.26)] hover:-translate-y-px hover:bg-[#dbbfae] transition-all mt-8 w-full" onClick={onBackToWorkspace}>
          Return to Workspace
        </button>
      </div>
    </section>
