...
export default function WorklistRow({
  ...
  const bodyProps = onRowClick
    ? {
        ...
        onClick: onRowClick,
        className:
          "min-w-0 flex-1 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--accent)] focus-visible:ring-offset-2 rounded",
      }
    : {
    ...
    >
      ...
      <div className="ml-auto flex shrink-0 items-center gap-3">
        ...
        <button
          ...
          className="min-h-[44px] min-w-[44px] rounded-md px-4 text-[13px] font-medium text-[color:var(--accent)] transition-colors hover:bg-[color:var(--accent)]/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--accent)] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
